...
function App() {
  ...
  const addNewRandomTweets = () => {
    const randomTweets = [
      ...
      'Quem mais vai ficar acordado até tarde para assistir à chuva de meteoros hoje à noite? ☄️ #CéuNoturno',
      'Lembrete: seja gentil consigo mesmo e com os outros. Um pouco de compaixão faz toda a diferença. 🤍 #Positividade',
      'Dica técnica do dia: sempre faça backup dos seus dados! Você vai agradecer a mesmo mais tarde. 📼 #ConselhoTecnológico',
    ]
